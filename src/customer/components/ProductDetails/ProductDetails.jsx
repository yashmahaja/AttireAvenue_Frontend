                    ...
                    <div className="lg-col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <form className="mt-10">
                                ...
                                <button onClick={()=> handleAddtoCart()} className="mt-3 px-8 py-4 text-white rounded-md hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500" style={{ backgroundColor: '#915ffd' }}>
                                    Add To Cart
                                </button>
                        ...
                        <div className="m-2 py-8 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>59893 Ratings</p>
                                </div>
                                ...
                                <Box className="mt-5">
                                    ...
                                    <Grid container alignItems="center" spacing={2}>
                                        ...
                                        <Grid item xs={9}>
                                            <LinearProgress
                                                sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 10, width: '70%' }}
                                                variant='determinate'
                                                value={40}
                                                color='success'
                                            />
                ...
                {/* Similar Products */}
                 <section className='pt-10 mb-10'>
                    ...
                    <div className='flex flex-wrap space-y-5'>
                        {mens_kurta.map((item) => <HomeSectionCard data={item}/>)}
                    </div>
                    </section>                                   
